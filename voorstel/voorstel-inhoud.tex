...
Netwerkbeheer vormt een kritieke component binnen moderne IT-infrastructuren. Het accuraat bijhouden van netwerkinventarisaties en -documentatie is essentieel voor efficiënt beheer, probleemoplossing en beveiliging. Echter, in veel organisaties raken deze inventarisaties snel verouderd omdat wijzigingen in de infrastructuur niet consistent worden bijgehouden~\autocite{Astera2025}. Dit probleem manifesteert zich vooral in dynamische IT-omgevingen waar systemen en apparaten voortdurend veranderen, waardoor handmatige documentatieprocessen onvoldoende zijn om de actualiteit te garanderen.
...
ServiceNow benadrukt het belang van automatische netwerkdetectie voor het bijhouden van accurate netwerkinventarisaties en het verbeteren van netwerkdocumentatie~\autocite{ServiceNow2024}. Automatische detectie kan bijdragen aan het realiseren van een betrouwbare netwerkdocumentatie. Echter, er blijft behoefte aan praktische evaluaties binnen concrete organisatiecontexten die kwantificeren hoeveel verbetering automatische detectie daadwerkelijk oplevert ten opzichte van handmatige processen.
...
Voorafgaand aan de implementatie worden baselinemetingen uitgevoerd om de huidige staat van de netwerkdocumentatie binnen Citymesh vast te leggen:
\begin{itemize}
...
De geselecteerde tool wordt geïmplementeerd en geconfigureerd binnen de bestaande infrastructuur van Citymesh. Dit omvat de installatie, configuratie van discoveryprotocollen (SNMP, LLDP, etc.), integratie met bestaande netwerkdocumentatiesystemen binnen Citymesh, en het opzetten van automatische synchronisatieprocessen.
...
\begin{itemize}
  ...
  \item \textbf{Documentatie- en inventorysystemen:} Afhankelijk van de organisatiecontext (bijv. NetBox, Confluence, of andere bestaande systemen)
  \item \textbf{Monitoring tools:} Voor het verzamelen van kwantitatieve data over documentatieupdates
\end{itemize}
...
\begin{itemize}
  \item \textbf{Probleemdomeinvragen:} Beantwoord via baselinemetingen en interviews met netwerkbeheerders
  \item \textbf{Oplossingsdomeinvragen:} Beantwoord via vergelijkende tool-evaluatie, praktische implementatie en kwantitatieve metingen na implementatie
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Foutreductie:} Een afname van 50-70\% in het aantal foutieve of onvolledige registraties, gemeten door vergelijking van baselinemetingen met postimplementatie metingen.
