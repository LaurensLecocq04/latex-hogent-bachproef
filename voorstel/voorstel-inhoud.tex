...
\begin{itemize}
  ...
  \item Concrete aanbevelingen voor netwerkbeheerders over de implementatie, configuratie en organisatorische inbedding van NetBox Discovery
\end{itemize}
...
Op basis van bestaand onderzoek naar automatische netwerkdocumentatie en discovery-architecturen worden de volgende resultaten verwacht.\autocite{Campbell2007,JohanSigholm2007}
