...
\begin{itemize}
  ...
  \item \textbf{Relevantie voor draadloze omgevingen:} kan de oplossing zinvol omgaan met draadloze use-cases (o.a. access points en devices in een gedistribueerde context)?
  ...
  \item \textbf{Uitbreidbaarheid:} kan de oplossing geconfigureerd of aangevuld worden wanneer bepaalde datatypes, zoals neighbors en kabels, niet volledig automatisch landen?
 \end{itemize}
...
Tijdens de evaluatie werd vastgesteld dat Slurp'it conceptueel kan aansluiten op het doel van automatische en gestructureerde netwerkdocumentatie, maar dat de oplossing betalend is en daardoor minder haalbaar wordt in de context van dit project. Hierdoor bleef Slurp'it buiten scope voor een volwaardige implementatie en werd het niet geselecteerd als primaire tool.
...
\begin{itemize}
  ...
  \item \textbf{Uitbreidbaarheid:} waar discovery niet volledig automatisch landt, zoals bij LLDP-neighbors, is het mogelijk om de ontbrekende functionaliteit aan te vullen met \texttt{NetworkTool} en de NetBox API.
\end{itemize}
