...
\begin{itemize}
  ...
  \item \textbf{Uitbreidbaarheid:} waar discovery niet volledig automatisch landt (LLDP-neighbors/kabelrelaties), kon je de ontbrekende functionaliteit aanvullen met een eigen pipeline (\texttt{NetworkTool} + NetBox API).
\end{itemize}
