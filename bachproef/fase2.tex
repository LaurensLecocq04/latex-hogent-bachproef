...
\begin{itemize}
  ...
  \item \textbf{Uitbreidbaarheid:} waar discovery niet volledig automatisch landt, zoals bij LLDP-neighbors, is het mogelijk om de ontbrekende functionaliteit aan te vullen met de pipeline (NetworkTool + NetBox API).
\end{itemize}
