...
\begin{itemize}
  ...
  \item gerichte voor/na-metingen: correctheid van device-attributen en kabelrelaties in NetBox vóór en na de toepassing van NetBox Discovery, op vier sites met verschillende profielen (zie \S\ref{sec:operationalisering}).
\end{itemize}
