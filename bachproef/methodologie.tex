...
\begin{itemize}
  \item Actualiteit: mate waarin NetBox-data overeenkomt met de actuele infrastructuurtoestand (geverifieerd via discovery-output);
  ...
  \item Resterende manuele last: datavelden of relaties die ook na discovery nog manueel of via aanvullende verwerking met \texttt{NetworkTool} verwerkt moeten worden.
\end{itemize}
...
\begin{itemize}
  ...
  \item Koninklijke Stallingen: kleinere site (1 router, 2 switches, 5 AP's) met al consistente naamgeving maar zonder gedocumenteerde kabelrelaties.
