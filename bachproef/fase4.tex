...
De \texttt{NetworkTool}-toepassing, opgebouwd met een Streamlit-gebaseerde GUI, ondersteunt het discoveryproces met een modulaire opbouw voor live dataverzameling, utility-functies en NetBox-synchronisatie. Daardoor blijft de werking beheersbaar en kunnen extra workflows toegevoegd worden.
...
De vernieuwde GUI bevat vier tabs: \emph{Agent Manager}, \emph{Network Scanner}, \emph{SNMP Discovery} en \emph{CVE Scanner}. Daarnaast werd een Ruckus vSZ-tab toegevoegd voor API-gestuurde synchronisatie van access points per zone naar NetBox. Dit breidt de oorspronkelijke workflow uit met subnet-sweeps, vulnerability checks en vendor-specifieke AP-synchronisatie.
